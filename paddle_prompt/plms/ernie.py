...
class ErnieForPretraining(ErniePretrainedModel):
    def __init__(self, ernie: ErniePretrainedModel):
        super(ErnieForPretraining, self).__init__()
        self.ernie: ErniePretrainedModel = ernie
        self.heads = ErniePretrainingHeads(
    ...
    def forward(
        ...
        with paddle.static.amp.fp16_guard():
            ...
            prediction_scores, _ = self.heads(
    ...
    def predict(self,
        ...
        return paddle.softmax(prediction_logits)
